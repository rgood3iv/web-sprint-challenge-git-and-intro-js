...
console.log('task 6', addArtist(artists, 'Robert', '1985-Present', 'Web Design', 'American', 'Im a new father. I also cant wait to get better with this'));
...
function artistInfo(array, name){ 
  ...
  console.log('task 8;', artistInfo(artists, 'Edouard Manet'));
